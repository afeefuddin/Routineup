...
ActiveRecord::Schema[7.1].define(version: 2024_11_12_210621) do
  ...
  create_table "group_subjects", id: false, force: :cascade do |t|
    t.bigint "group_id", null: false
    t.bigint "subject_id", null: false
    t.index ["group_id", "subject_id"], name: "index_group_subjects_on_group_id_and_subject_id", unique: true
